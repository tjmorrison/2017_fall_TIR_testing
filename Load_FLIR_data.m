function [ frame,metaData  ] = Load_FLIR_data( path,emissivity,distance,reflectedTemp,atmosphereTemp,...
    extOpticsTemp,extOpticsTransmission,estAtmosphericTransmission,atmosphericTransmission,...
    relativeHumidity)
...
%       path                    % data path
%       need to add nx, ny, nt, freq options
...
objectParameters.emissivity = emissivity;
objectParameters.distance = distance;
objectParameters.reflectedTemp =reflectedTemp;
objectParameters.atmosphereTemp = atmosphereTemp;
objectParameters.extOpticsTemp = extOpticsTemp;
objectParameters.extOpticsTransmission = extOpticsTransmission;
objectParameters.estAtmosphericTransmission = estAtmosphericTransmission;
objectParameters.atmosphericTransmission = atmosphericTransmission;
objectParameters.relativeHumidity = relativeHumidity;
%Options for Loading data
%%%%%%%%
...
Image_Seq = FlirMovieReader(path);
Image_Seq.unit = unit;
